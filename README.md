...
## Requirements  
 ...
 - If you do not have admin access to the computer that analysis is performed on, you will need to contact your system administrator for specific guidelines on using Nix and Docker. 
   - Note that in order for Nix to work, it normally needs root access. [Binary installation](https://github.com/burberrylab/scrna-tools/edit/main/README.md#nix-package-manager-instrustions-without-sudo-or-root-access) may get around this issue, but it is not yet fully tested.
